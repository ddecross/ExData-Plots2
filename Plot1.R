...
merged_table.melt <- melt(merged_table, id=id.vars.for.melt, measure.vars = c("Emissions"))
...
png(file = "./Project Code/Exploratory Data Analysis/Project 2/plot1.png",
    width = 480,
    height = 480)
...
title(main="Total Emissions Showing Trend by Year", sub="Emissions from All Sources")
dev.off()
